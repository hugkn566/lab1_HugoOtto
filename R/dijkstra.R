...
#' @details This function computes Dijkstra's algorithm to find the shortest paths between nodes in a graph. 
#' @return A vector containing the shortest paths from \code{init_node} to every other node in the graph.
#' @references https://en.wikipedia.org/wiki/Dijkstra\%27s_algorithm (\href{https://en.wikipedia.org/wiki/Dijkstra\%27s_algorithm}{Wikipedia}).
#' @examples
